...
namespace FinancialSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260829134239_AddMovementIdentityLinkRollback")]
    partial class AddMovementIdentityLinkRollback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinancialSystem.Domain.Dedupe.MovementIdentityLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("IdentityGroupId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MovementIdentityLinks", (string)null);
                });

            modelBuilder.Entity("FinancialSystem.Domain.Dedupe.MovementIdentityLinkRollback", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MovementIdentityLinkRollbacks", (string)null);
                });

            modelBuilder.Entity("FinancialSystem.Domain.Dedupe.MovementIdentityLinkRollbackMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MovementIdentityLinkRollbackMembers", (string)null);
                });
            ...
            modelBuilder.Entity("FinancialSystem.Domain.Entities.BankStatement", b =>
                {
                    ...
                    b.Property<DateTime?>("MerchantAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("FinancialSystem.Domain.Entities.ImportBatch", b =>
                {
                    ...
                    b.Property<string>("ConsistencyIssues")
                        .HasMaxLength(2000)
            ...
            modelBuilder.Entity("FinancialSystem.Domain.Planning.PlanningItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("PlanningMonthId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlanningMonthId")
                        .HasDatabaseName("IX_PlanningItems_PlanningMonthId");

                    b.ToTable("PlanningItems", (string)null);
                });

            modelBuilder.Entity("FinancialSystem.Domain.Planning.PlanningMonth", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FinancialSystem.Domain.Review.MovementAuditDecision", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MovementAuditDecisions", (string)null);
                });

            modelBuilder.Entity("FinancialSystem.Domain.Dedupe.MovementIdentityLinkRollbackMember", b =>
                {
                    b.HasOne("FinancialSystem.Domain.Dedupe.MovementIdentityLinkRollback", "Rollback")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("FinancialSystem.Domain.Planning.PlanningItem", b =>
                {
                    b.HasOne("FinancialSystem.Domain.Planning.PlanningMonth", "PlanningMonth")
                        .WithMany("Items")
                        .HasForeignKey("PlanningMonthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
