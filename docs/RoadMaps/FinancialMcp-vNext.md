...
* El patrón de idempotencia de `BbvaBankStatementImporter` (`ExternalId` + índice único + consulta previa) — es el patrón a **copiar** hacia tarjeta (Épica I), no a rediseñar.
